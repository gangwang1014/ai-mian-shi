...
public class EsTest {
    ...
    public void indexDocument() {
        ...
        doc.put("answer", "Yes");
        doc.put("userId", 1L);
        doc.put("editTime", "2025-08-01 10:00:00");
        doc.put("createTime", "2025-08-01 09:00:00");
        doc.put("updateTime", "2025-08-01 09:10:00");
    ...
    public void getDocument() {
        ...
        Map<String, Object> document = elasticsearchTemplate.get(documentId, Map.class, IndexCoordinates.of(INDEX_NAME));
    ...
    public void deleteIndex() {
        IndexOperations indexOps = elasticsearchTemplate.indexOps(IndexCoordinates.of(INDEX_NAME));
